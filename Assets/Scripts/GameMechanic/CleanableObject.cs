...
public class CleanableObject : MonoBehaviour, IDirtCounter
{
    ...
    public float GetDirtAmout()
    {
        ...
        for (int x = 0; x < _templateDirtMask.width; x++)
        {
            ...
            {
                dirtAmount += _templateDirtMask.GetPixel(x, y).g;
            }
        }
        return dirtAmount / IDirtCounter.MaxDirtValue;
    }

    public static explicit operator CleanableObject(GameObject v)
    {
